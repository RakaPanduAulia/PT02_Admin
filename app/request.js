angular.module('App').factory("request", function ($http, $cookies) {
    ...
    obj.updateStatusProductOrder = function (id, object) {
        var data = {id:id, product_order:object};
        return $http.post(api_base + 'updateStatusProductOrder', data, config).then(function (results) { return results.data; });
    };
	...
	obj.updateOrderPaid = function (id, order, order_detail) {
		var data = {id:id, product_order:order, product_order_detail:order_detail};
		return $http.post(api_base + 'updateOrderPaid', data, config).then(function (results) { return results.data; });
	};
	obj.refundOrder = function (id, returned) {
		var data = {id:id, returned:returned};
		return $http.post(api_base + 'refundOrder', data, config).then(function (results) { return results.data; });
	};
	...
	// CONFIG ----------------------------------------------------------------------------------------------------------
    obj.getAllConfigByGroup = function (group) {
        return $http.get(api_base + 'getAllConfigByGroup?group='+group, config);
    };
    ...
    // SHIPPING --------------------------------------------------------------------------------------------------------
    obj.getAllCountryCode = function () {
        return $http.get(api_base + 'getAllCountryCode');
    };
    obj.getOneShipping = function (id) {
        return $http.get(api_base + 'getOneShipping?id='+id);
    };
    obj.getAllShippingByPage = function (page, limit, q) {
        return $http.get(api_base + 'getAllShippingByPage?page='+page+'&limit='+limit+'&q='+q);
    };
    obj.listShipping = function (q) {
        return $http.get(api_base + 'listShipping?q='+q);
    };
    obj.getAllShippingCount = function(q) {
        return $http.get(api_base + 'getAllShippingCount?q='+q);
    };
    obj.insertOneShipping = function (object) {
        return $http.post(api_base + 'insertOneShipping', object, config).then(function (results) { return results.data; });
    };
    obj.updateOneShipping = function (id, object) {
        var data = {id:id, shipping:object};
        return $http.post(api_base + 'updateOneShipping', data, config).then(function (results) { return results.data; });
    };
    obj.deleteOneShipping = function (id) {
        return $http.get(api_base + 'deleteOneShipping?id='+id, config).then(function (results) { return results.data; });
    };
    obj.updateAllShipping = function (object) {
        return $http.post(api_base + 'updateAllShipping', object, config).then(function (results) { return results.data; });
    };
